#!/usr/bin/env python3
"""Breast Panel B on KS (Tan 2014) genelist-restricted archetypes. Writes panel_b_ks_genelist/."""
...
SCORES = BREAST / "results" / "panel_a_ks_genelist" / "pc_scores.npy"
LABELS_SRC = BREAST / "results" / "panel_b" / "pam50_labels_panelA.csv"
OUT = BREAST / "results" / "panel_b_ks_genelist"
FIG = BREAST / "figures"
...
def main():
    ...
    print(f"Suggested k from Panel A KS genelist: {k_star} ({suggested[1] if len(suggested) > 1 else ''})")
    ...
    plot_enrichment(table, FIG / "Figure_1B_breast_ks_genelist.png", N_BINS, n_arcs)
    ...
    print("Wrote", FIG / "Figure_1B_breast_ks_genelist.png")
    return 0
