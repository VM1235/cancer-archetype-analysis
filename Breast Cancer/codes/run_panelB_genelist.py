#!/usr/bin/env python3
"""Breast Panel B on PAM50-restricted archetypes. Writes panel_b_genelist/."""
...
SCORES = BREAST / "results" / "panel_a_genelist" / "pc_scores.npy"
LABELS_SRC = BREAST / "results" / "panel_b" / "pam50_labels_panelA.csv"
OUT = BREAST / "results" / "panel_b_genelist"
FIG = BREAST / "figures"
PANEL_A = BREAST / "results" / "panel_a_genelist"
...
def plot_enrichment(table, path, n_bins, n_arcs):
    ...
    fig.suptitle(
        "Figure 1B  —  PAM50 enrichment (gene-list archetypes; LumA/Normal removed)",
        y=1.06,
        fontsize=13,
    )
    fig.tight_layout()
...
def main():
    ...
    plot_enrichment(table, FIG / "Figure_1B_breast_genelist.png", N_BINS, n_arcs)
    ...
    print("Wrote", FIG / "Figure_1B_breast_genelist.png")
    return 0
