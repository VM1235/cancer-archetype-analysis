#!/usr/bin/env python3
"""Breast Panel C on KS (Tan 2014) genelist-restricted archetypes. Writes panel_c_ks_genelist/.
...
OUT = BREAST / "results" / "panel_c_ks_genelist"
FIG = BREAST / "figures"
...
def main():
    ...
    fig.suptitle("Figure 1C  —  TCGA-BRCA IHC, KS-restricted archetypes", y=1.02)
    fig.tight_layout()
    fig.savefig(FIG / "Figure_1C_tcga_ks_genelist.png", dpi=200)
    plt.close(fig)
    print("Wrote", FIG / "Figure_1C_tcga_ks_genelist.png")
