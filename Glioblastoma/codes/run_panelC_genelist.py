#!/usr/bin/env python3
"""GBM Panel C on Wang2017-restricted archetypes. Writes panel_c_genelist/.

Reads prepared TCGA tables from panel_c_tcga/ but does not write there.
"""
...
CL_MATRIX = GBM / "data" / "processed" / "input_panelA_wang2017_genelist.csv"
SCORES_PATH = GBM / "results" / "panel_a_genelist" / "pc_scores.npy"
N_PCS_PATH = GBM / "results" / "panel_a_genelist" / "n_pcs.txt"
SUGGESTED = GBM / "results" / "panel_a_genelist" / "suggested_k.txt"
...
OUT = GBM / "results" / "panel_c_genelist"
FIG = GBM / "figures"
...
def main():
    ...
    arcs_path = GBM / "results" / "panel_a_genelist" / f"archetypes_k{k}_parti.npy"
    ...
    fig.suptitle("Figure 1C  —  TCGA-GBM Verhaak, Wang2017-restricted archetypes", y=1.02)
    fig.tight_layout()
    fig.savefig(FIG / "Figure_1C_gbm_genelist.png", dpi=200)
    plt.close(fig)
    print("Wrote", FIG / "Figure_1C_gbm_genelist.png")
